...
const whyData = [
  {
    ...
    description:
      "Menggunakan bahan-bahan alami yang ramah lingkungan salah satunya adalah probiotik.",
  },
  {
    id: 2,
    icon: (
...
const Livestock = () => {
  return (
    <>
      <HeroSectionGeneral
        imgUrl="/img-livestock-hero.jpeg"
        category="Peternakan"
        title={
          <h1 className="p-4 text-center text-3xl font-bold !leading-tight text-white lg:text-5xl xl:text-[56px]">
            ...
            Produk Bioteknologi Berkualitas
          </h1>
        }
      />
        ...
        <ContainerSection>
          <div className="flex flex-col gap-6 rounded-3xl bg-[#00802B] p-8 md:flex-row md:items-center lg:gap-12 lg:p-16">
            ...
            <p className="w-fit text-white xl:w-[880px]">
              ...
              di bidang peternakan, kami sedang dalam proses untuk menghadirkan
              produk-produk berkualitas seperti probiotik khusus ruminansia dan
              unggas.
            </p>
          </div>
        </ContainerSection>
