...
const productData = [
  ...
  {
    id: "insektisida-hayati",
    name: "Insektisida Hayati",
    description:
      "Insektisida ramah lingkungan berbasis mikroorganisme untuk pengendalian hama yang efektif dan aman.",
    products: [
      {
        id: 1,
        name: "BioGuard",
        description:
          "Insektisida hayati yang efektif mengendalikan berbagai jenis hama tanaman. Menggunakan mikroorganisme alami yang aman bagi lingkungan.",
        url: "/hero-tentang-kami.jpg",
      },
      {
        id: 2,
        name: "NaturalShield",
        description:
          "Perlindungan alami untuk tanaman Anda dengan formula khusus yang tidak meninggalkan residu berbahaya pada hasil panen.",
        url: "/img-news-1.png",
      },
    ],
  },
